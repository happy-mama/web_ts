		...
		<div class="e">
			...
			<div class="msg">
				...
				<div class="description">
					...
					<ul class="list">
						<li>
							Created Discord bot with music player from Youtube
						</li>
						<li>
							Writed my own Proxy
						</li>
						...
						<li>
							Maked a Minecraft Paper plugin on <p class="special">Java</p>
						</li>
						<li>
							A litle know <p class="special">Unity</p> and <p class="special">Unreal</p> engines<br>
						</li>
						<li>
							Some experience in <p class="special">C++, C#, C, Python</p>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="msg">
				...
				<div class="description">
					Half a year of work in cyberclub as programmer (developed telegram bots).
				</div>
			</div>
			<div class="space"></div>
			<div class="msg">
				...
				<div class="description">
					...
					<ul class="list">
						<li>
							<p class="special">Discord</p> NaN#3922
						</li>
						<li>
							<p class="special">eMail</p> main@happy.tatar
						</li>
					</ul>
				</div>
			</div>
